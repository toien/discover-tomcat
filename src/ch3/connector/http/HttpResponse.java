...
import ch3.connector.ResponseStream;
import ch3.connector.ResponseWriter;
...
public class HttpResponse implements HttpServletResponse {
	 ...
	 */
	protected final SimpleDateFormat format = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss zzz",
			Locale.US);
	/**
